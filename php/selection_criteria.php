...
<div class="container mx-auto px-12 py-6 bg-white rounded-md shadow-md">
    ...
    <form action="dashboard.php" method="GET" id="criteriaForm">
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div>
                <label for="facility" class="block text-sm font-bold text-gray-700">Facility</label>
            ...
            <div>
                <label for="work_center" class="block text-sm font-bold text-gray-700">Work Center</label>
            ...
            <div>
                <label for="device_name" class="block text-sm font-bold text-gray-700">Device Name</label>
            ...
            <div>
                <label for="test_program" class="block text-sm font-bold text-gray-700">Test Program</label>
            ...
            <div>
                <label for="lot" class="block text-sm font-bold text-gray-700">Lot</label>
            ...
            <div>
                <label for="wafer" class="block text-sm font-bold text-gray-700">Wafer</label>
            ...
            <div class="col-span-1">
                <label for="parameter" class="block text-sm font-bold text-gray-700">Parameter</label>
